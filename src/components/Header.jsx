...
const Header = () => {
    ...
    return (
        <div className="flex justify-between absolute w-screen px-8 py-2 bg-gradient-to-b from-black z-10 ">
            <img
                src={logo} alt='Netflix-logo' className='w-32 h-12 mt-2 cursor-pointer' onClick={() => navigate("/browse")}
            />
            {user && (
                    ...
                    {isOpen && (
                        <div className="absolute right-0 mt-4 w-48 bg-gray-900 text-white rounded-xl shadow-lg ring-1 ring-white/10 z-50 animate-fadeIn">
                            <ul className="py-2 space-y-1">
                                <li className="px-4 py-2 hover:bg-gray-800 cursor-pointer rounded-md transition duration-200">Profile</li>
